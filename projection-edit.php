        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <select name="movie-id"
                        id="movie-id"
                        required
                        class="form-control <?php echo (!empty($errors['movie-id'])?'is-invalid':''); ?>">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local"
                       ...
                       class="form-control <?php echo (!empty($errors['datetime'])?'is-invalid':''); ?>"/>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-sm">
                    ...
                    <select name="dimensions"
                            id="dimensions"
                            required
                            class="form-control <?php echo (!empty($errors['dimensions'])?'is-invalid':''); ?>">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-sm">
                    ...
                    <input type="number"
                           ...
                           min="1"
                           required
                           class="form-control <?php echo (!empty($errors['capacity'])?'is-invalid':''); ?>"
                           value="<?php echo htmlspecialchars(@$projection['capacity']);?>" />
                ...
                <div class="form-group col-sm">
                    ...
                    <select name="hall"
                            id="hall"
                            required
                            class="form-control <?php echo (!empty($errors['hall'])?'is-invalid':''); ?>">
